  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Viewport
        ...
        className="size-full rounded-[inherit] transition-colors outline-none focus-visible:outline-none"
      >
        {children}
      </ScrollAreaPrimitive.Viewport>
      <ScrollBar />
  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Thumb
        ...
        className="relative flex-1 rounded-full bg-[var(--scroll-thumb)] hover:bg-accent"
      />
    </ScrollAreaPrimitive.Scrollbar>
  )
}
